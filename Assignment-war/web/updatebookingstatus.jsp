    ...
    <body class="bg-gray-100">
        <div class="flex">
            ...
            <div class="flex-1 p-10 bg-gray-100">
                <h1 class="text-2xl font-bold text-center mb-4">Update Booking Status</h1>

                <div class="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
                    <form method="POST" action="/Assignment-war/updatebookingstatus" class="space-y-4">
                        <input type="hidden" name="bookingid" value="${bookingid}"/>
                        <div>
                            <label for="status" class="block text-sm font-medium text-gray-700"><i class="fas fa-info-circle mr-2"></i>Status</label>
