                    ...
                    <table class="min-w-full bg-white">
                        <tbody>
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b border-gray-200">${nuser.username}</td>
                            </tr>
                            <tr>
                                <td class="py-2 px-4 border-b border-gray-200">
                                    <i class="fa-solid fa-address-card"></i> <strong>Name:</strong>
                                </td>
                            ...
                            <tr>
                                <td class="py-2 px-4 border-b border-gray-200">
                                    <i class="fas fa-money-bill-wave"></i> <strong>Salary:</strong>
                                </td>
                                <td class="py-2 px-4 border-b border-gray-200">RM ${nuser.salary}</td>
                            </tr>
                            <tr>
                                <td class="py-2 px-4 border-b border-gray-200">
                                    <i class="fas fa-star"></i> <strong>Average Rating:</strong>
                                </td>
                                <td class="py-2 px-4 border-b border-gray-200">${rating}/10</td>
                            </tr>
                        </tbody>
                    </table>
                    <!-- Edit Profile Button -->
