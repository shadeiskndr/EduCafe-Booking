...
<body class="bg-gray-100">
    <div class="flex">
        ...
        <div class="flex-1 p-10 bg-gray-100">
            <h1 class="text-2xl font-bold text-center my-6">Edit Booking Page</h1>
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                <form method="POST" action="/Assignment-war/editbooking">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="datebooking" id="datebooking" value="${nbooking.datebooking}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                            <i class="fas fa-edit mr-2"></i></i>Edit Booking
                        </button>
                    </div>
                </form>
